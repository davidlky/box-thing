...
class FloatingWidgetService : Service(), View.OnClickListener {
    ...
    private fun implementTouchListenerToFloatingWidgetView() {
        ...
        mFloatingWidgetView!!.findViewById<View>(R.id.root_container).setOnTouchListener(object : View.OnTouchListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.close_expanded_view -> {
                ...
                if (isLeft) {
                    moveToLeft(mFloatingWidgetView!!.x.toInt())
                } else {
                    moveToRight(mFloatingWidgetView!!.x.toInt())
                }
            }
